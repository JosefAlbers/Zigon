...
var ASM_CONSTS = {
  96344: () => { if (document.fullscreenElement) return 1; },  
 96390: () => { return document.getElementById('canvas').width; },  
 96442: () => { return parseInt(document.getElementById('canvas').style.width); },  
 96510: () => { document.exitFullscreen(); },  
 96537: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 96610: () => { if (document.fullscreenElement) return 1; },  
 96656: () => { return document.getElementById('canvas').width; },  
 96708: () => { return screen.width; },  
 96733: () => { document.exitFullscreen(); },  
 96760: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 96893: () => { return window.innerWidth; },  
 96919: () => { return window.innerHeight; },  
 96946: () => { if (document.fullscreenElement) return 1; },  
 96992: () => { return document.getElementById('canvas').width; },  
 97044: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97112: () => { if (document.fullscreenElement) return 1; },  
 97158: () => { return document.getElementById('canvas').width; },  
 97210: () => { return screen.width; },  
 97235: () => { return window.innerWidth; },  
 97261: () => { return window.innerHeight; },  
 97288: () => { if (document.fullscreenElement) return 1; },  
 97334: () => { return document.getElementById('canvas').width; },  
 97386: () => { return screen.width; },  
 97411: () => { document.exitFullscreen(); },  
 97438: () => { if (document.fullscreenElement) return 1; },  
 97484: () => { return document.getElementById('canvas').width; },  
 97536: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97604: () => { document.exitFullscreen(); },  
 97631: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 97689: () => { return screen.width; },  
 97714: () => { return screen.height; },  
 97740: () => { return window.screenX; },  
 97767: () => { return window.screenY; },  
 97794: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 97847: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 97918: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 97975: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98231: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98302: () => { if (document.fullscreenElement) return 1; },  
 98348: () => { return window.innerWidth; },  
 98374: () => { return window.innerHeight; },  
 98401: () => { if (document.pointerLockElement) return 1; }
};

// Imports from the Wasm binary.
var _main = Module['_main'] = makeInvalidEarlyAccess('_main');
var _init_state = Module['_init_state'] = makeInvalidEarlyAccess('_init_state');
var _gogo = Module['_gogo'] = makeInvalidEarlyAccess('_gogo');
var _gameLoop = Module['_gameLoop'] = makeInvalidEarlyAccess('_gameLoop');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['init_state'] != 'undefined', 'missing Wasm export: init_state');
  assert(typeof wasmExports['gogo'] != 'undefined', 'missing Wasm export: gogo');
  assert(typeof wasmExports['gameLoop'] != 'undefined', 'missing Wasm export: gameLoop');
  ...
  _init_state = Module['_init_state'] = createExportWrapper('init_state', 2);
  _gogo = Module['_gogo'] = createExportWrapper('gogo', 0);
  _gameLoop = Module['_gameLoop'] = createExportWrapper('gameLoop', 0);
